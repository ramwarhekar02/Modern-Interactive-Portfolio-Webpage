...
const Footer = () => {
  return (
    <div data-scroll data-scroll-section data-scroll-speed="-.1" className=' w-full h-screen rounded-xl mt-16 pt-12'>
        <div className='relative rounded-t-xl mx-12 flex pb-14 '>
            <div className='w-1/2 tracking-tighter uppercase font-bold h-full leading-tight pr-[30%] text-[6.2vw]'>
                <h1>Eye - Opening</h1>
            ...
            <div className='w-1/2 tracking-tighter uppercase font-bold h-full leading-none text-[6.2vw]'>
                <h1>Presentations</h1>
                <div className='text-[1vw] grid tracking-normal mt-10 leading-6'>
                    <h3 className='mb-4'>S.</h3>
                    {["Instagram", "Facebook", "Twitter", "LinkedIn"].map((index, item)=>
                        <a key={item} className='underline underline-offset-4'>{index}</a>
                    )}
                </div>
                <div className='text-[1vw] grid tracking-normal mt-8 leading-6'>
                    <h3 className='mt-4'>L.</h3>
                    <div className='flex justify-between'>
                        <div className='text-[1vw] grid tracking-normal mt-4 leading-6'>
                            {["202-1965 W 4th Ave", "Vancouver,Canada", "30 Chukarina", "Lviv, Ukraine"].map((index, item)=>
                                <a key={item} className='underline underline-offset-4'>{index}</a>
                            )}
                        </div>
                        <div>
                            <h3 className='-mt-6'>M.</h3>
                            <div className='text-[1vw] grid tracking-normal mt-8 leading-6'>
                                {["Home", "Services", "Our Work", "About Us", "Iinsights", "Contact us"].map((index, item)=>
                                    <a key={item} className='underline underline-offset-4'>{index}</a>
                                )}
                            </div>
                        </div>
                ...
                <div className='text-[1.2vw] grid tracking-normal mt-4 leading-6 lowercase'>
                    <h3 className='mb-4'>E.</h3>
                    <a href="#" className='underline underline-offset-4'>hello@ochi.design</a>
                </div>
            </div>
        </div>
    </div>
